...
function getOrderID(form) {
    ...
    var input_vat = form.querySelector('[name="f_vat"]');
    ...
    var paymentMethodType = form.querySelector('[name="paymentMethodType"]');
    var paymentSubjectType = form.querySelector('[name="paymentSubjectType"]');
    ...
    if (input_ym_merchant_receipt !== null) {
        ...
        objCheck = {
            ...
            'items': [{
                    ...
                    'paymentMethodType': paymentMethodType && paymentMethodType.value ? paymentMethodType.value : 'full_prepayment',
                    'paymentSubjectType': paymentSubjectType && paymentSubjectType.value ? paymentSubjectType.value : 'commodity'
                }]
        }
    }
            ...
            if (xmlhttp.status == 200) {
                try {
                    ...
                    setTimeout(function () {
                        ...
                        //alert('confirmation_url: ' + jsonResponse.confirmation_url);

                        if (jsonResponse.error)
                            alert('Îøèáêà: ' + jsonResponse.error);
