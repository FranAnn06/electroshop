...
if (!$ZIPfrom) { 
	...
	return $result;
        ...
        $CodePVZ .= "<div id='pvzcse'></div><button onclick='csepvzwidget(\"init\", {token: \"38a0abb7099ea700c597b17764ffe6a9\",city:\"".$GeoGUID."\"}); csepvzwidget(\"open\", {callback: function (params) { console.log(params); document.getElementById(\"soa-property-".$GUIDPvz."\").value = params.guid; document.getElementById(\"soa-property-".$AddressName."\").value = params.geography_name + \", \" + params.name +\", \"+ params.address; alert(\"".Loc::getMessage("KCE_PVZ_DATASEND")."\");document.getElementById(\"pvzcse\").innerHTML =\"".Loc::getMessage("KCE_PVZ_DATASEND")."\"}});return false;'>".Loc::getMessage("KCE_PVZ_VIBOR")."</button>";
